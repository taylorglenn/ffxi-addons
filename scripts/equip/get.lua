...
windower.send_command(
  table.concat({
    ...
    'wait 1',
    'input /echo +-------------------------------------------------------------+',
    'input /echo |  Retrieving all items. wait '..timeToWait..' seconds. Do not move!',
    'input /echo +-------------------------------------------------------------+',
    'input //timers c "retrieving items from Porter Moogle" '..timeToWait..' down',
    'input //po retrieve',
    'wait '..timeToWait,
    'input /echo +------------------------------------------------+',
    'input /echo |  Done retrieving items! Thanks for waiting!',
    'input /echo +------------------------------------------------+',
    'input //put Storage Slip* case all',
    'input /echo +------------------------+',
    'input /echo |  All slips stored.',
    'input /echo +------------------------+',
    'wait 1',
    'input //gs equip sets.idle', 
  }, '\;')
)